...
contract sZDERC20Token is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked ZodiacDAO Token", "sZD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sZD supply to increase staking balances relative to profit_
